...
gps4 <- gps4 %>%
  ...
  filter(time_difference >= 180 & time_difference <= 18000 )
...
The above code is to draw the crowd of people who stay at one place more than 180s (3 minutes) but less than 18000s (5 hours). The reason I filter out the stay duration more than 5 hours is people may stay at home or at office.
...
Because of limited time and efforts, I choose "2014-01-11" as an example to show the unofficial relationships among GAStech personnel. In this file we can find out who is in clusters in the same place then infer they may have unofficial relationships with each other.
...
This is not the end of the assignment. To view the solution for question 1, 2 and 3, please click here(https://linlizhong.netlify.app/posts/2021-07-25-vast-challenge-mc2/)